...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .permitAll()
                .requestMatchers("/userinactive/**","/registrationFailed", "/rf/**","/login/**","register/**", "/save/**","/registrationsuccesfull/**", "/", "/addnew/**","/logo.gif","/logo_blue.jpg", "/timetable.png","/register.png","/registered-courses.png","/exam.png","/scores.png","/editexam.png")
                .permitAll()
                .anyRequest()
                .authenticated().and()
                .formLogin()
